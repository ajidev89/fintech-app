...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ->from('info@hallfield.ng', 'Hallfield')
                ...
                ->action('Click here to Reset Password', route('ChangePassword', [$notifiable->email,$this->token]) )
                ->line('If you did not reset your password, no further action is required.')
                ->line('Thank you for using Hallfield');
    }
